...
const AddCoupenCode = () => {
  ...
  const currDate = new Date().toJSON().substr(0, 10);
  const currTime = new Date().toLocaleTimeString().slice(0, 8);
  // const currDateTime = new Date(toLocaleTimeString().toLocaleTimeString())
  return (
    <div className="Product_main_container1g">
      ...
      <Card>
        <CardContent>
          <Typography>Add Coupen Code</Typography>
          ...
          <div className="sub_container">
            ...
            <TextField
              type="datetime-local"
              value={`${currDate} ${currTime}`}
            />
            <TextField type="date" value={currDate} /> */}
          </div>
