...
//
export const ADD_GALLARY_API = `${BASE_URL}/uploadimage`;
export const GET_GALLARY_API = `${BASE_URL}/getgallary`;
//
export const GET_CATEGORY_API = `${BASE_URL}/getparentcategory`


export const ADD_PRODUCT_API = `${BASE_URL}/addproduct`;
export const ADD_CATEGORY_API =`${BASE_URL}/addcategorylist`;
